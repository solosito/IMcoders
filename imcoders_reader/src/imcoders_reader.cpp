...
{
IMCoder::IMCoder(ros::NodeHandle& nh, const ros::NodeHandle& private_nh) : nh_(nh)
{
...
void IMCoder::init(ros::NodeHandle& nh)
{
  ...
  RTIMUSettings* settings_ = new RTIMUSettings(calibration_file_path_.c_str(), calibration_file_name_.c_str());
...
void IMCoder::pubData()
{
  ...
  mag_msg_.magnetic_field_covariance = { 0, 0, 0, 0, 0, 0, 0, 0, 0 };
